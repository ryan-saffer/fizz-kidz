...
The Lilita font is also exported at `@fizz-kidz/ui/assets/fonts/LilitaOne.ttf` so consumers can preload the same asset for critical headings. Vite consumers can import that path with `?url`.
