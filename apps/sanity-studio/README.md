...
The old per-card booking-order value is hidden and ignored during the card-order cutover. Remove its stored values and schema definition after the compatible Website, server, and Portal release is verified.
